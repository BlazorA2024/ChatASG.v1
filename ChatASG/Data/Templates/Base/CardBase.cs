...
namespace ChatASG.Data.Templates.Base
{
    ...
    public class ThemeComponentCard
    {
        public bool? Dark { set; get; }=false;
    ...
    public class StyleBaseComponentCard : ComponentBase, IStyleBaseComponentCard
    {
        ...
        [Parameter]
        public ThemeComponentCard IsDark { set; get; }
